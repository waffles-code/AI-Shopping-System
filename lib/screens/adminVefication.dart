...
class AdminVefyScreen extends StatefulWidget {
  ...
  @override
  _AdminVefyScreenState createState() => _AdminVefyScreenState();
}

class _AdminVefyScreenState extends State<AdminVefyScreen> {
