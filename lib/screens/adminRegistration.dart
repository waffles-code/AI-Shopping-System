...
import 'package:aishop/screens/adminVefication.dart';
...
class AdminRegisterScreen extends StatefulWidget {
  AdminRegisterScreen({this.cityName, this.longitude, this.latitude});
  final cityName;
  final longitude;
  final latitude;
  ...
  State<StatefulWidget> createState() {
    return _AdminRegisterScreenState();
  }
}
